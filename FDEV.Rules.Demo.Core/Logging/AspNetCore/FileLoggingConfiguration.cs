namespace FDEV.Rules.Demo.Core.Logging.AspNetCore
{
    ...
    internal class FileLoggingConfiguration
    {
        ...
        internal const string DefaultOutputTemplate = "{Timestamp:o} {RequestId,13} [{Level:u3}] {Message} ({EventId:x8}){NewLine}{Exception}";

        /// <summary>
        /// Filename to write. The filename may include <c>{Date}</c> to specify how the date portion of
        /// the filename is calculated. May include environment variables.
        /// </summary>
        ...
        /// For unrestricted growth, pass <c>null</c>. The default is 1 GiB.
        /// </summary>
        ...
        /// For unlimited retention, pass <c>null</c>. The default is 31.
        /// </summary>
