...
using FDEV.Rules.Demo.Domain.Common.Dynamic;
...
namespace FDEV.Rules.Demo.Domain.Common.Notification
{
    ...
    public class ViewModelBase : DynamicObject, INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        private string CanExecutePrefix { get; } = DevData.CanExecutePrefix;

        private static string ExecutePrefix { get; } = DevData.ExecutePrefix;
